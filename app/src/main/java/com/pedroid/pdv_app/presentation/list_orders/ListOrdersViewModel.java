...
public class ListOrdersViewModel extends ViewModel {
    ...
    public void deleteOrder(int orderId) {
        disposables.add(
                deleteOrderUseCase.execute(orderId)
                        ...
                        .subscribe(
                                success -> {
                                    deleteOrderFromRecyclerList(orderId);
                                },
    ...
    private void deleteOrderFromRecyclerList(int orderId) {
        List<OrderListAdapterItem> currentOrders = orders.getValue();
        ...
        if (currentOrders != null) {
            ...
            if (newOrdersList.isEmpty()) {
                newOrdersList.add(new OrderListAdapterItem.EmptyItem());
            }
            orders.setValue(newOrdersList);
        }
    }
